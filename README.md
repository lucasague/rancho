...
- **Cuentas abiertas**: agrupa las casas 1 a 6 en una cuadrícula 3×2, mostrando los pedidos arrastrados entre turnos, el total pendiente y permite liquidar toda la cuenta eligiendo si el pago fue en efectivo o por Sinpe.
...
- **Registro de pagos**: cada pedido nace como “pendiente”. Desde la tabla principal, la pestaña de cierre o la pestaña de cuentas abiertas se puede registrar el cobro en efectivo o Sinpe; en el caso de las casas, el pago se liquida de una sola vez. Las ventas pagadas se suman automáticamente al resumen diario y al correo de cierre.
