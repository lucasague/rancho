...
- **Casas**: agrupa los pedidos asignados a las casas 1 a 6 en una cuadrícula 3×2. Desde aquí se pueden revisar los detalles, registrar el pago o liberar la orden para regresar al listado general.
...
- **Registro de pagos**: cada pedido nace como “pendiente”. Desde la tabla principal, la pestaña de cierre o la pestaña de casas se puede registrar el cobro por efectivo o Sinpe, o bien moverlo a una casa desde el nuevo desplegable de asignación. Las ventas pagadas se suman automáticamente al resumen diario y al correo de cierre.
...
3. **Clasifica los pedidos por casa** usando el desplegable disponible en la tabla principal, la pestaña de cierre o directamente en la pestaña final de casas para seguir el saldo de cada una.
